...
peer_path = "./test3_result"
img = Image.open(os.path.join(peer_path, "test_3.png"))
wtm_set = []
for file in os.listdir(os.path.join(peer_path, "test3_watermark")):
    file_path = os.path.join(os.path.join(peer_path, "test3_watermark"), file)
...
with open(os.path.join(result_path, "result_5.txt"), mode="w") as f:
