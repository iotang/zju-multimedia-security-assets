...
from eblk8 import eblk8_notrailing


def test_img(img, seed, shared, confidence_wi, confidence_wo, lock, msg: int):
    if msg >= 0:
        msg_get, confidence = eblk8_notrailing.detect(
            eblk8_notrailing.embed(img, msg, 8, seed, math.sqrt(10)), 8, seed
        )
        ...
        msg_get, confidence = eblk8_notrailing.detect(img, 8, seed)
